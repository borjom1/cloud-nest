...
public class User extends TableImpl<UserRecord> {
    ...
    /**
     * The reference instance of <code>um.user</code>
     */
    ...
    /**
     * The column <code>um.user.id</code>.
     */
    ...
    /**
     * The column <code>um.user.updated</code>.
     */
    public final TableField<UserRecord, LocalDateTime> UPDATED = createField(DSL.name("updated"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");
    ...
    /**
     * Create an aliased <code>um.user</code> table reference
     */
    ...
    /**
     * Create a <code>um.user</code> table reference
     */
    public User() {
